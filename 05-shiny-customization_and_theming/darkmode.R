...
ui <- page_sidebar(
  ...
  # `input_dark_mode()` adds a built-in light/dark toggle. With Bootstrap 5
  # bslib automatically derives the dark variant of the theme above, so we no
  # longer need to define a separate `dark` theme or swap it in by hand.
  sidebar = sidebar(
